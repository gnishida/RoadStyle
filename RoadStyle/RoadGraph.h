...
public:
	...
	void generateMesh(bool showHighways, bool showAvenues, bool showStreets, float widthPerLane, float highwayHeight, float avenueHeight, float curbRatio, bool drawLocalStreets);
